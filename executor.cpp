...
int main(int argc, char *argv[])
{
    ...
    if (query_label == true)
    {
        ...
        std::cout << "标签大小为 " << exp_1 << " 时,在线搜索的查询时间为" << onlineCost[exp_1] / vaild[exp_1] << std::endl;
        std::cout << std::endl;
        std::cout << "标签大小为 " << exp_2 << " 时,基于索引的查询时间为" << indexCost[exp_2] / vaild[exp_2] << std::endl;
        std::cout << "标签大小为 " << exp_2 << " 时,在线搜索的查询时间为" << onlineCost[exp_2] / vaild[exp_2] << std::endl;
        std::cout << std::endl;
        std::cout << "标签大小为 " << exp_3 << " 时,基于索引的查询时间为" << indexCost[exp_3] / vaild[exp_3] << std::endl;
        std::cout << "标签大小为 " << exp_3 << " 时,在线搜索的查询时间为" << onlineCost[exp_3] / vaild[exp_3] << std::endl;
        std::cout << std::endl;
        std::cout << "标签大小为 " << exp_4 << " 时,基于索引的查询时间为" << indexCost[exp_4] / vaild[exp_4] << std::endl;
        std::cout << "标签大小为 " << exp_4 << " 时,在线搜索的查询时间为" << onlineCost[exp_4] / vaild[exp_4] << std::endl;
        std::cout << std::endl;
    ...
    else
    {
        ...
        for (int i = 0; i < 5; i++)
        {
            ...
            std::cout << "k为 " << k << " 时,基于索引的查询时间为" << std::chrono::duration_cast<std::chrono::milliseconds>(query2 - query1).count() << std::endl;
            std::cout << "k为 " << k << " 时,在线搜索的查询时间为" << std::chrono::duration_cast<std::chrono::milliseconds>(query3 - query2).count() << std::endl;
            ...
            std::cout << "k为 " << k << " 时,在线搜索查询结果数量为" << solution5.size() << std::endl;
            // std::cout << "k为 " << k << " 时,Baseline查询结果数量为" << solution6.size() << std::endl;
            std::cout << std::endl;
        }
        std::cout << "基于索引的平均查询时间为" << indexCost / 5 << std::endl;
        std::cout << "在线搜索的平均查询时间为" << onlineCost / 5 << std::endl;
